            ...
            <div class="panell-body border-bottom " style="margin-top: 20px">
                <div class="row">
                    ...
                    <div class="col-lg-8 btn-group" >
                        <h1><a href="<?=Url::to(['article/view','id'=>$list['id']])?>"><?=$list['title']?></a></h1>
                        
                        <p class="post-content"><?=$list['content']?></p>
                        <a href="<?=Url::to(['article/view','id'=>$list['id']])?>"><button class="btn btn-warning no-radius btn-sm pull-right">阅读全文</button></a>
                    </div>
                </div>
