...
.navbar-collapse{
    ...
    background-image: linear-gradient(to bottom, #337ab7, #343a40);
...
<div class="panel">
    <?php if (!empty($data['Wish'])):?>
        <?php foreach ($data['Wish'] as $list):?>
...
<div class="panel-body">
    <form action="/" id="w0" method="post">
        <div class="form-group input-group field-Wish-content required">
            <textarea id="wish-content" class="form-control" name="content" placeholder="留下我的祝福祈祷" rows="" cols=""></textarea>
        </div>
    </form>
