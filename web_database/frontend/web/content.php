...
<body>
  ...
  <div class="site-wrap">
          ...
          <div class="collapse navbar-collapse" id="main-nav">
            ...
            <ul class="navbar-nav ml-auto">
              ...
              <li class="nav-item active">
                <a class="nav-link" href="index.php?r=site/page4">疫情新闻</a>
              </li>
              <li class="nav-item">
                <a class="nav-link" href="index.php?r=site/page5">疾病知识</a>
              </li>
            </ul>
      ...
      <div class="container">
        <div class="row align-items-end">
          <div class="col-lg-7">
            <h3>
              <?php 
		  $conn=mysqli_connect("localhost","root","wp010214","ourteam","3306");
		  $topic=$_GET['topic'];
		  $SQLstr="select * from News where topic='$topic'";
		  ...
		  {
		  ?>
              <span class="STYLE1"><?php echo $row[0]?></span></h3>
          </div>
        </div>
      </div>
    </div>
    ...
    <!-- BEGIN: #footer -->
    <p class="mb-0 text-black STYLE2"><?php echo $row[1]?></p>
	<?php }}?>
